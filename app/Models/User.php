...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'email', 'password', 'avatar', 'phone_number', 'facebook', 'instagram', 'status', 'is_admin','is_partner','photo_id'];
    ...
    {
        return $this->is_agent === self::USER_ADMIN;
    }

      public function isPartner()
    {
        return $this->is_partner === self::USER_PARTNER;
    }
    ...
    public function ipaddress(){
        return $this->belongsTo(Visitor::class,'ip_id','id');
    }
