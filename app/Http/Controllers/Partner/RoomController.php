...
class RoomController extends Controller
{
    ...
    public function list(Request $request,$hotel_id)
    {
        $rooms = $this->room->getListByHotel($hotel_id);

        return view('partner.room.room_list', [
    ...
    public function createView(Request $request,$hotel_id)
    {
        ...
        return view('partner.room.room_create', [
            'hotel_id'=>$hotel_id,
            'rooms'=>$rooms,
            'amenities'=>$amenities,
            'hotels'=>$hotels,
...
//dd($request->all(), $data);
        ...
        if ($model->save()) {
            return redirect(route('partner_room_list',['hotel_id' => $hotel_id]))->with('success', 'Create room success!');
        }
    ...
    public function add_calendar(Request $request, $type, $room_id)
    {
        ...
        return view('partner.room.add_calendar', [
            'totaldays' => $totaldays,
            'date'      => $date,
            'type'      => $type,
            'room_id'   => $room_id,
