...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Blade::directive('price_formatter', function ($price) {
            return "<i class='fas fa-rupee-sign custom-fs-14'></i> <?php echo  number_format($price,0); ?>";
        });
        
        Blade::directive('date_formatter', function ($date) {
            return "<?php echo  \Carbon\Carbon::parse($date)->format('D,d M Y'); ?>";
        });
