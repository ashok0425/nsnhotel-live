<form action="{{route('partner_place_create')}}" enctype="multipart/form-data" method="post">
    @method('put')
    @csrf
    ...
    <div class="tab-content">
        ...
        <div id="location">
            ...
            <div id="map"></div>
             <div class="form-group mt-4">
                ...
                <input type="text" class="form-control" id="place_address" name="bus_stop" value="{{$place->bus_stop}}" placeholder="Bus Stand 34 KM" autocomplete="off" maxlength="12">
                <label for="place_address">Distance from any Popular Tourist Place:</label>
                <input type="text" class="form-control" id="place_address" name="other_place" value="{{$place->other_place}}" placeholder="St Pauls Catholic Church 34 KM" maxlength="12" autocomplete="off">
        ...
        <div id="contact_info">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="place_email" name="email" value="{{$place->email}}" placeholder="Enter email address" disabled>
            </div>
            <div class="form-group">
                <label for="name">Phone number:</label>
                <input type="text" class="form-control" id="place_phone_number" name="phone_number" value="{{$place->phone_number}}" placeholder="Enter phone number" disabled>
            </div>
            <div class="form-group">
                <label for="name">Website:</label>
                <input type="text" class="form-control" id="place_website" name="website" value="{{$place->website}}" placeholder="Enter website url" disabled>
            </div>
        </div>
     ...
     <div class="form-group">
              <label class="btn btn-secondary" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="date" name="o_u_s_to" value="{{$place['o_u_s_to']}}" class="join-btn">Room out of stock From
                </label>
                <!--</div>-->
                <!--<div class="form-group">-->
                <label class="btn btn-secondary" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="date" name="o_u_s_from" value="{{$place['o_u_s_from']}}" class="join-btn">Room out of stock To
                </label> 
                </div>
    </div>
