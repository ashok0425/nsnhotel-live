    ...
    <div class="tab-content">
                        ...
                        @foreach($languages as $index => $language)
                            <div class="tab-pane fade show {{$index !== 0 ?: "active"}}" id="language_{{$language->code}}" role="tabpanel" aria-labelledby="home-tab">
                                <div class="form-group">
                                    <label for="place_name">Hotel Name
        ...
        <div id="location">
            ...
            <div class="form-group mt-4">
                ...
                <input type="text" class="form-control" id="place_address" name="shopping_complex" placeholder="Phoenix United Mal 45 KM" autocomplete="off" required>-->
            </div>
        ...
        <div id="contact_info">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="place_email" name="email" disabled>
            </div>
            <div class="form-group">
                <label for="place_phone_number">Phone number:</label>
                <input type="text" class="form-control" id="place_phone_number" name="phone_number" disabled>
            </div>
            <div class="form-group">
                <label for="place_website">Website:</label>
                <input type="text" class="form-control" id="place_website" name="website" disabled>
            </div>
        </div>
