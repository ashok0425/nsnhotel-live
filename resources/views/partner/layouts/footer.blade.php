...
searchBox.addListener('places_changed', function () {
	...
	<script src="https://maps.googleapis.com/maps/api/js?key={{setting('goolge_map_api_key', 'AIzaSyAwODglsF1sybi50BTXwKl6DsvwiCtl0PY')}}&callback=placeMap&libraries=places"async></script>
	<!-- end js include path -->
	 --}}
