    ...
    <div class="tab-content">
        ...
        <div id="contact_info">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="place_website" name="website" value="www.nsnhotels.com">
            </div>
        </div>
        ...
        <div id="link_affiliate">
            ...
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-secondary" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" name="booking_type" checked value="{{\App\Models\Booking::TYPE_BOOKING_FORM}}" class="join-btn">Booking form
                </label>
                <label class="btn btn-secondary" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
