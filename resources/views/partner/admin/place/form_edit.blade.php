<form action="{{route('admin_place_create')}}" enctype="multipart/form-data" method="post">
    ...
    <div class="tab-content">
                        ...
                        @foreach($languages as $index => $language)
                            ...
                            <div class="tab-pane fade show {{$index !== 0 ?: "active"}}" id="language_{{$language->code}}" role="tabpanel" aria-labelledby="home-tab">
                                <div class="form-group">
                                    <label for="place_name">Hotel Name <small>({{$language->code}})</small>: *</label>
        ...
        <div id="location">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <label for="place_address">State: *</label>
        ...
        <div id="link_affiliate">
            ...
            <div class="btn-group" data-toggle="buttons">
                <label class="btn btn-secondary {{isActive($place->booking_type, \App\Models\Booking::TYPE_BOOKING_FORM)}}" data-toggle-class="btn-default" data-toggle-passive-class="btn-default">
                    <input type="radio" class="join-btn" name="booking_type" checked value="{{\App\Models\Booking::TYPE_BOOKING_FORM}}" {{isChecked($place->booking_type, \App\Models\Booking::TYPE_BOOKING_FORM)}} >Booking Form
                </label>
        ...
        <div id="golo_seo">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="seo_keywords" name="seo_keywords">{{$place['seo_keywords']}}</textarea>
            </div>
        </div>
    </div>
