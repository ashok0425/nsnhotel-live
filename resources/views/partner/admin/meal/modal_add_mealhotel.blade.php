...
<div class="modal fade" id="modal_mealhotel_add" tabindex="-1" role="dialog" aria-labelledby="modal_add_meal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('admin_create_meal')}}" method="post" data-parsley-validate enctype="multipart/form-data">
                @csrf
