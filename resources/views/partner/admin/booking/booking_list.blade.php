                                                            ...
                                                            @if(isset($booking['place']))
                                                                ...
                                                                @if($booking->status === \App\Models\Booking::STATUS_PENDING || $booking->status === \App\Models\Booking::STATUS_DEACTIVE)
                                                                    <form class="d-inline" action="{{route('admin_booking_update_status')}}" method="POST">
                                                                        ...
                                                                        <button type="button" class="btn btn-success booking_approve ml-2" data-id="{{$booking->id}}">Approve</button>
                                                                    </form>
                                                                @endif
                                                                @if($booking->status === \App\Models\Booking::STATUS_PENDING || $booking->status === \App\Models\Booking::STATUS_ACTIVE)
                                                                    <form class="d-inline" action="{{route('admin_booking_update_status')}}" method="POST">
                                                                        ...
                                                                        <button type="button" class="btn btn-danger booking_cancel ml-2">Cancel</button>
                                                                    </form>
                                                                @endif
                                                                <form action="{{route('admin_booking_delete',$booking->id)}}" method="POST">
                                                                @method('DELETE')
                                                                @csrf
                                                                <button type="button" class="btn btn-danger booking_delete ml-2">Delete</button>
                                                            </form>
                                                            @else
                                                                <i>Place deleted</i>
                                                            @endif
