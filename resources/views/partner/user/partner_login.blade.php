...
<head>
    ...
    <title>Partner Panel - NSN Hotels</title>
...
<body>
    <div class="limiter">
        <div class="container-login100 page-background">
            <div class="wrap-login100">
                <form action="{{ route('login') }}" class="login100-form validate-form" method="post" id="login_partner">
                    @csrf
    ...
    <script>
    $('#login_partner').submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.code === 200) {
                    window.location = `${app_url}/partnercp`;
                } else {
