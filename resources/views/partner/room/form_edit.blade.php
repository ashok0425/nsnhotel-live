<form action="{{route('partner_room_create',$hotel_id)}}" enctype="multipart/form-data" method="post">
    @method('put')
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="number" value="{{$rooms->onepersonprice}}" placeholder="Hourly Price" name="onepersonprice" class="form-control">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
