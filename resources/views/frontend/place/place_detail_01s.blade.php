            ...
            <div id="nsnhotelsslider" class="owl-carousel">
                @if(isset($place->gallery))
                    ...
                    <div class="nsnhotelsbanner">
                        <img src="{{getImageUrl($gallery)}}" alt="{{$place->name}}" class="img-responsive" width="1080" height="1080"/>
                    </div>
                    @endforeach
                    @else
                     <div class="nsnhotelsbanner">
                        <img src="https://via.placeholder.com/1280x480?text=NSN" alt="{{$place->name}}" class="img-responsive" width="1920" height="576"/>
                    </div>
                @endif
            </div>
        </div>
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-md-12">
				<div class="nsnhotelstitle">
					<h1 class="nsnhotelsdetailsname">{{$place->name}}</h1>
