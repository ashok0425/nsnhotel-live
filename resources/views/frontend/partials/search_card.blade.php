    ...
    <div class="col-12 col-sm-9 col-md-9">
        <div class="row">
            <div class="col-12 col-sm-5 col-md-5 nsnhotelsphoto pr-0">
                <div id=""
                    class="owl-carousel nsnhotelsimageslider @if (isset($place->roomsData->first()->hourlyprice) && !empty($place->roomsData->first()->hourlyprice)) display_after @endif">
                    @if (isset($place->gallery))
                        @foreach ($place->gallery as $gallery)
                            <div class="nsnhotelsimagesliderbox ">
                                <img src="{{ getImageUrl($gallery) }}" alt="{{ $place->name }}" class="img-responsive"
