    ...
    <div class="col-12 col-sm-9 col-md-9">
        <div class="row">
            <div class="col-12 col-sm-5 col-md-5 nsnhotelsphoto pr-0">
                <div id=""
                    class="  @if (isset($place->roomsData->first()->hourlyprice) && !empty($place->roomsData->first()->hourlyprice)) display_after @endif">
                    @if (isset($place->gallery))
                            <div class="nsnhotelsimagesliderbox ">
                                <img src="{{ getImageUrl($place->thumb) }}" alt="{{ $place->name }}" class="img-responsive"
            ...
            <div class="col-12 col-sm-7 col-md-7 ">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <ul class="hotel_feature mb-1 custom-fs-12">
                        <li>
                ...
                <div>
                    <ul class="">
                        ...
                        <?php $placeAmenities = $amenities->whereIn('id', $place->amenities); ?>
                        @if (isset($placeAmenities))
                            @foreach ($placeAmenities->take(20) as $key => $item)
 ...
 <div class="d-flex justify-md-content-between justify-content-around mt-3">
    ...
    <div class="">
        ...
        <div class="supportareapopup">
            <div id="myDIV" class="showAssistance{{ $place->id }} d-none hideAssistance">
