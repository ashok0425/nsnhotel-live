            ...
            <div class="row">
                <div class="col-12 col-sm-3 col-md-3">
                    ...
                    <ul class=" d-flex custom-text-white custom-fw-700 custom-fs-18">
                        <li>Follow us :</li>
                        <li><a class="custom-text-white custom-fs-26" href="https://www.facebook.com/NSNhotels/?ti=as"
                                target="_blank"><i class="fas fa-facebook"></i></a></li>
                        <li><a class="custom-text-white"href="https://twitter.com/HotelsNsn?t=_Fi2KuR6_6-MZO-ipDqYCQ&s=09"
                                target="_blank"><span class="fas fa-twitter"></span></a></li>
                        <li><a class="custom-text-white" href="https://instagram.com/nsn_hotels?utm_medium=copy_link"
                                target="_blank"><span class="fas fa-instagram"></span></a></li>
                        <li><a class="custom-text-white" href="https://www.linkedin.com/in/nsn-hotels-690aa220a"
                                target="_blank"><span class="fas fa-linkedin"></span></a></li>
                        <li><a class="custom-text-white" href="https://youtube.com/channel/UC9k_pfRBtPlD4GtpzgYrDTg"
                                target="_blank"><span class="fas fa-youtube"></span></a></li>
                        <li><a class="custom-text-white" href="https://pin.it/76hl1As" target="_blank"><span
                ...
                <div class="col-12 col-sm-3 col-md-3">
                    ...
                    <ul class="">
                        <li class="my-2"><i class="fas fa-envelope custom-text-white"></i> <a
                                href="mailto:admin@nsnhotels.com" class="custom-text-white">admin@nsnhotels.com</a></li>
                        <li class="my-2"><i class="fas fa-envelope custom-text-white"></i> <a
                        ...
                        <li class="my-2"><i class="fas fa-phone custom-text-white"></i> <a href="tel:(+91)7683003096"
                                class="custom-text-white">(+91) 8585852954</a></li>
                    </ul>
                </div>
                <div class="col-12 col-sm-3 col-md-3">
