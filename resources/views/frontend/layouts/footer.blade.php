    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-3 col-md-3">
                ...
                <p class="custom-text-white line-height-2 custom-fs-12">Nsnhotels provides online Hotel Bookings of hotels and resorts in India. Book budget, cheap and luxury hotels or resorts at cost effective prices.</p>
                <ul class=" d-flex custom-text-white custom-fw-700 custom-fs-18">
                    <li>Follow us :</li>
                    <li><a class="custom-text-white custom-fs-26" href="https://www.facebook.com/NSNhotels/?ti=as" target="_blank"><i class="fas fa-facebook"></i></a></li>
                    <li><a  class="custom-text-white"href="https://twitter.com/HotelsNsn?t=_Fi2KuR6_6-MZO-ipDqYCQ&s=09" target="_blank"><span class="fas fa-twitter"></span></a></li>
                    <li><a class="custom-text-white" href="https://instagram.com/nsn_hotels?utm_medium=copy_link" target="_blank"><span class="fas fa-instagram"></span></a></li>
                    <li><a class="custom-text-white" href="https://www.linkedin.com/in/nsn-hotels-690aa220a" target="_blank"><span class="fas fa-linkedin"></span></a></li>
                    <li><a class="custom-text-white" href="https://youtube.com/channel/UC9k_pfRBtPlD4GtpzgYrDTg" target="_blank"><span class="fas fa-youtube"></span></a></li>
                    <li><a class="custom-text-white" href="https://pin.it/76hl1As" target="_blank"><span class="fas fa-pinterest"></span></a></li>
                </ul>
                ...
                <div class="row">
                    <div class="col-md-6 col-6">
                        <a href="https://play.google.com/store/apps/details?id=com.hotel.nsn">
                            <img src="{{getImageurl('playstore.svg',true)}}" alt="NSN HOTELS Play Store" class="img-fluid">
                            </a>
                    </div>
                    <div class="col-md-6 col-6">
                        <a href="" class="py-5">
                            <img src="{{getImageurl('appstore.svg',true)}}" alt="NSN HOTELS APP Store" class="img-fluid ">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-3 col-md-3">
                ...
                <ul class="d-flex  w-75">
                    <li class="bg-white mx-1 p-2 custom-border-radius-5"><img src="{{asset('frontend/images/american.png')}}" alt="Payment Methods" /></li>
                    <li class="bg-white mx-1 p-2 custom-border-radius-5"><img src="{{asset('frontend/images/discover.png')}}" alt="Payment Methods" /></li>
                    <li class="bg-white mx-1 p-2 custom-border-radius-5"><img src="{{asset('frontend/images/master.png')}}" alt="Payment Methods" /></li>
                    <li class="bg-white mx-1 p-2 custom-border-radius-5"><img src="{{asset('frontend/images/paypal.png')}}" alt="Payment Methods" /></li>
                    <li class="bg-white mx-1 p-2 custom-border-radius-5"><img src="{{asset('frontend/images/visa.png')}}" alt="Payment Methods" /></li>
                </ul>
                <p class="line-height-2 custom-fs-12 custom-text-white mt-1">You can pay the charges of booking amount directly online or through the scan code .  
