...
<link rel="icon" sizes="16x16" href="{{getImageUrl(setting('logo') ?  setting('logo') : 'assets/images/assets/logo.png')}}">
<meta name="csrf-token" content="{{csrf_token()}}"/>
<meta name="title" content="Best hotel with a challenging price | NSN Hotels"/>
<meta name="description" content="Choose from a wide range of properties which nsnhotels.com offers. Search now! Book your Hotel online. Great rates. Secure Booking. 24/7 Customer Service. Villas. Motels. Best Price Guarantee. Save 10% with Genius. No Booking Fees."/>
...
<script>var gmz_params = {i18n: {guest: 'Guest', guests: 'Guests', infant: 'Infant',infants: 'Infants',adult: 'Adult', adults: 'Adults', children: 'Children', featured: 'Featured',}}
</script>
@stack('style')
<!-- Google Tag Manager -->
...
})(window,document,'script','dataLayer','GTM-M4HW2BZ');</script>
<!-- End Google Tag Manager -->
</head>
<body>
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M4HW2BZ"
...
<noscript><img height="1" width="1" style="display:none"
  src="https://www.facebook.com/tr?id=323172226696460&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
<noscript>
 <img height="1" width="1" 
src="https://www.facebook.com/tr?id=1188266251653315&ev=PageView
...
<noscript>
 <img height="1" width="1" 
src="https://www.facebook.com/tr?id=266463828767771&ev=PageView
&noscript=1" alt="facebook"/>
</noscript>    
    		<header>
