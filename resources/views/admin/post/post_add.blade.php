                                                    ...
                                                    @foreach ($languages as $index => $language)
                                                        <li class="nav-item">
                                                            <a class="nav-link {{ $index !== 0 ?: 'active' }}"
                                                                ...
                                                                href="#language_{{ $language->code }}" role="tab"
                                                        ...
                                                        <div class="tab-pane fade show {{ $index !== 0 ?: 'active' }}"
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="post_title_{{ $language->code }}"
                                                                        name="{{ $language->code }}[title]"
                                                                        value="{{ $trans ? $trans->title : '' }}"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="post_content_{{ $language->code }}">Content
                                                                    <small>({{ $language->code }})</small>
                                                                    :</label>
                                                                <textarea type="text" class="form-control tinymce_editor" id="post_content_{{ $language->code }}"
                                                                    name="{{ $language->code }}[content]" rows="10">{{ $trans ? $trans->content : '' }}</textarea>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            ...
                                            <div class="x_content">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="seo_title"
                                                        name="seo_title" value="{{ $post ? $post['seo_title'] : '' }}">
                                                </div>
                                                <div class="form-group">
                                                    <label for="seo_description">Meta Description:</label>
                                                    <textarea class="form-control" id="seo_description" name="seo_description">{{ $post ? $post['seo_description'] : '' }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="x_panel">
                                                ...
                                                <div class="x_content">
                                                    @foreach ($categories as $cat)
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="flat" name="category[]"
                                                                    value="{{ $cat->id }}"
                                                                    {{ isChecked($cat->id, $post ? $post['category'] : '') }}>
                                                                {{ $cat->name }}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                            ...
                                            <div class="x_content">
                                                <label class="post_thumb" for="post_thumb">
                                                    <img id="preview_thumb"
                                                        src="{{ getImageUrl($post ? $post['thumb'] : '') }}"
                                                        alt="post thumb">
                                                    <input type="file" class="form-control" id="post_thumb"
                                                        name="thumb" accept="image/*">
                                                </label>
                                            </div>
                                        </div>
