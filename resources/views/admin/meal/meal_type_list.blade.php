                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Meals Type</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item"
                                        href="index">Manage</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li><a class="parent-item" href="#">Meals Type</a>&nbsp;</i>
                                </li>
                            </ol>
                        </div>
                    </div>
                                                 ...
                                                 @foreach($model as $item)
                                                    <tr>
                                                        <td>{{$item->id}}</td>
                                                         <td>{{$item->type}}</td>
                                                          <td>
                                                            <input type="checkbox" class="js-switch meal_type_status" name="status" data-id="{{$item->id}}" {{isChecked(1, $item->status)}} />
                                                        </td>
                                                        <td>
                                                       ...
                                                       data-name="{{$item->type}}"
                                                            ...
                                                            <form class="d-inline" action="{{route('admin_mealtype_delete',$item->id)}}" method="POST">
                                                                @method('DELETE')
                                                                @csrf
...
@include('admin.meal.modal_add_meal_type')
@push('scripts')
