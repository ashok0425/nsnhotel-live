                                ...
                                <div class="card-head">
                                    ...
                                    <div class="tools">
                                     ...
                                     <div class="pull-right">
                                        <a href ="{{route('admin_add_faq')}}" class="btn btn-primary" id="btn_add_city" type="button">+ Add Faq</a>
                                    </div>
                                                ...
                                                <tbody>
                                                 @foreach($faq as $city)
                                                    <tr>
                                                        ...
                                                        <td>{{$city->answer}}</td>
                                                        <td>
                                                             <form class="d-inline" action="{{route('admin_faq_delete',$city->id)}}" method="POST">
                                                                @method('DELETE')
                                                                @csrf
                                                                <button type="submit" class="btn btn-danger city_delete">Delete</button>
                                                            </form>
                                                             <a href ="{{route('admin_add_faq',['faq'=>$city->id])}}" class="btn btn-primary" id="btn_add_city" type="button">+ Edit Faq</a>
                                                        </td>
                                                        <tr>
